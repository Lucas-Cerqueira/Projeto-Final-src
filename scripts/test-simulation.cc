...
int main (int argc, char *argv[])
{
  ...
  */
  ...
  double totalSimTime = 716; // seconds
  ...
  Vector vel_vehA (80.0/3.6, 0.0, 0.0);
  Vector vel_vehB (90.0/3.6, 0.0, 0.0);
  ...
  SimulationMonitor simMonitor (3.0, logFile.c_str ());
